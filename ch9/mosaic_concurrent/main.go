...
func main() {
	...
	files := http.FileServer(http.Dir("ch9/mosaic_concurrent/public"))
...
func upload(w http.ResponseWriter, r *http.Request) {
	t, _ := template.ParseFiles("ch9/mosaic_concurrent/upload.html")
	_ = t.Execute(w, nil)
}
...
func mosaic(w http.ResponseWriter, r *http.Request) {
	...
	t, _ := template.ParseFiles("ch9/mosaic_concurrent/results.html")
